...
- **Bring any agent** — Codex, Amp, Claude Code, or any CLI command — just plug it in
...
Any CLI command works. Set it in `rift.yaml` or via `rift config --agent <cmd>`. Common agents include Codex, Amp, Claude Code, Copilot, Aider, Gemini, Kiro, and OpenCode.
